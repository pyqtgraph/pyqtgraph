# -*- coding: utf-8 -*-
#
# pyqtgraph documentation build configuration file for sphinx
#
# This file is execfile()d with the current directory set to its containing dir.
#
# Note that not all possible configuration values are present in this
# autogenerated file. (when it was created)
#
...
## Set an enviroment variable. remember all "modules" are actually created/initiased 
...
#needs_sphinx = '1.0' # were using latest
...
project = 'PyQtGraph'
copyright = '2011 - %s, Luke Campagnola' % datetime.datetime.now().isocalendar()[0]

# The version info for the project you're documenting, acts as replacement for
# |version| and |release|, also used in various other places throughout the
# built documents. (BUt where said pete!)
#
# The short X.Y version.
version = VERSION

## TODO: this is not implemented if even required ? 
...
def setup(app):
    app.connect("autodoc-skip-member", skip_special_methods)
