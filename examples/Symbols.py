...
plot.plot(data+12, pen=(119,172,48), symbolBrush=(119,172,48), symbolPen='w', symbol=makeRegularPolygon(3), symbolSize=14)
plot.plot(data+13, pen=(119,172,48), symbolBrush=(119,172,48), symbolPen='w', symbol=makeRegularPolygon(4), symbolSize=14)
plot.plot(data+14, pen=(119,172,48), symbolBrush=(119,172,48), symbolPen='w', symbol=makeRegularPolygon(5), symbolSize=14)
plot.plot(data+15, pen=(119,172,48), symbolBrush=(119,172,48), symbolPen='w', symbol=makeRegularPolygon(6), symbolSize=14)
plot.plot(data+16, pen=(119,172,48), symbolBrush=(119,172,48), symbolPen='w', symbol=makeRegularPolygon(7), symbolSize=14)
plot.plot(data+17, pen=(119,172,48), symbolBrush=(119,172,48), symbolPen='w', symbol=makeRegularPolygon(100), symbolSize=14)
plot.setXRange(-2, 4)
