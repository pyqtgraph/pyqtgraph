...
if USE_PYSIDE:
    ...
    #what residual QtGui things are there?
    
    #PyQt4.QGui -> PyQt5.QWidgets
    QtCore = _Qt5Core
    QtGui = _Qt5Widgets #this is the big switcheroo
    
    #not all of QtGui moved over to QtWidgets.  Copy some of them back...
    leftoverGuiAttrs = ["QPainterPath", "QTransform", "QVector3D",
                        "QMatrix4x4", "QColor", "QPalette", "QBrush", "QPixmap", "QImage",
