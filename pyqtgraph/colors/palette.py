...
def getQDarkStyleDarkQPalette():
    ...
    for ptype in (QtGui.QPalette.ColorGroup.Active, QtGui.QPalette.ColorGroup.Inactive):
        ...
        qpal.setColor(ptype, QtGui.QPalette.ColorRole.Window, BG_DARK)
        qpal.setColor(ptype, QtGui.QPalette.ColorRole.WindowText, FG_NORMAL)
        qpal.setColor(ptype, QtGui.QPalette.ColorRole.AlternateBase, BG_LIGHT)
        qpal.setColor(ptype, QtGui.QPalette.ColorRole.Button, BG_LIGHT)
        ...
        qpal.setColor(ptype, QtGui.QPalette.ColorRole.HighlightedText, FG_LIGHT)
    ...
    qpal.setColor(QtGui.QPalette.ColorGroup.Disabled, QtGui.QPalette.ColorRole.Base, BG_NORMAL)
    ...
    qpal.setColor(QtGui.QPalette.ColorGroup.Disabled, QtGui.QPalette.ColorRole.Text, FG_DARK)
    qpal.setColor(QtGui.QPalette.ColorGroup.Disabled, QtGui.QPalette.ColorRole.Highlight, BG_LIGHT)
    qpal.setColor(QtGui.QPalette.ColorGroup.Disabled, QtGui.QPalette.ColorRole.HighlightedText, FG_DARK)
    return qpal
