...
def load_from_xml():
    global xml_data
    if xml_data:
        param_dict = XMLParameterFactory.XML_string_to_parameter(xml_data)
        restored_params = Parameter.create(name='Restored Parameters', type='group', children=param_dict)
