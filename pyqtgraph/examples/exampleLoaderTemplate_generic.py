...
class Ui_Form(object):
    ...
    def retranslateUi(self, Form):
        ...
        self.qtLibCombo.setItemText(0, _translate("Form", "PyQt6"))
        self.qtLibCombo.setItemText(1, _translate("Form", "PySide6"))
        self.qtLibCombo.setItemText(2, _translate("Form", "PyQt5"))
        self.qtLibCombo.setItemText(3, _translate("Form", "PySide2"))
