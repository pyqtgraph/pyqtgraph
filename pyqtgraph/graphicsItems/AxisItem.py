...
class AxisItem(GraphicsWidget):
    ...
    def __init__(self, orientation, pen=None, linkView=None, parent=None, maxTickLength=-5,
                 showValues=True, autoScale=True):
        """
        ==============  ===============================================================
        **Arguments:**
        ...
        autoScale       (Bool) if True, the automatic shrinkage of the axis is
                        not allowed - PR #235 (new in version 0.9.11)
        ==============  ===============================================================
        """
        ...
        self.autoScale = False # used to shrink automatically the axis (or not)
