...
class Ui_Form(object):
    def setupUi(self, Form):
        ...
        self.averageGroup = QtWidgets.QFrame(Form)
        self.averageGroup.setGeometry(QtCore.QRect(10, 460, 221, 81))
        ...
        self.averageCheck = QtWidgets.QCheckBox(self.averageGroup)
        self.averageCheck.setObjectName("averageCheck")
        self.gridLayout_5.addWidget(self.averageCheck, 0, 0, 1, 2)
        ...
        # self.averageGroup.setObjectName("averageGroup")
        # self.gridLayout_5 = QtWidgets.QHBoxLayout(self.averageGroup)
    ...
    def retranslateUi(self, Form):
        ...
        self.averageCheck.setToolTip(_translate("Form", "Display averages of the curves displayed in this plot. The parameter list allows you to choose parameters to average over (if any are available)."))
        self.averageCheck.setText(_translate("Form", "Average"))
