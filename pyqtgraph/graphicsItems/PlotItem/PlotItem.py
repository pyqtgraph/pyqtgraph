...
class PlotItem(GraphicsWidget):
    ...
    **Signals:**
    ...
    def __init__(self, parent=None, name=None, labels=None, title=None, viewBox=None, axisItems=None, enableMenu=True,
                 **kargs):
        """
        ...
        *axisItems*     Optional dictionary instructing the PlotItem to use pre-constructed items
        ...
        self.ctrl.avgParamList.setVisible(False)
        self.ctrl.gridLayout_5.addSpacerItem(QtWidgets.QSpacerItem(100, 0))
    ...
    def showGrid(self, x=None, y=None, alpha=None):
        ...
        **Arguments:**
        ...
        if x is None and y is None and alpha is None:
            raise Exception(
                "Must specify at least one of x, y, or alpha.")  ## prevent people getting confused if they just call showGrid()
    ...
    def writeSvgCurves(self, fileName=None):
        ...
        for item in self.curves:
            if isinstance(item, PlotCurveItem):
                ...
                fh.write('<path fill="none" stroke="#%s" stroke-opacity="%f" stroke-width="1" d="M%f,%f ' % (
