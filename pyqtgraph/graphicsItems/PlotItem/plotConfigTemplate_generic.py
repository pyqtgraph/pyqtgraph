...
class Ui_Form(object):
    def setupUi(self, Form):
        ...
        self.lttbRadio = QtWidgets.QRadioButton(self.decimateGroup)
        self.lttbRadio.setObjectName("lttbRadio")
        self.gridLayout_4.addWidget(self.lttbRadio, 7, 1, 1, 1)
        self.lttbSpin = QtWidgets.QSpinBox(self.decimateGroup)
        self.lttbSpin.setMinimum(1)
        self.lttbSpin.setMaximum(100000)
        self.lttbSpin.setProperty("value", 1000)
        self.lttbSpin.setObjectName("lttbSpin")
        self.gridLayout_4.addWidget(self.lttbSpin, 7, 2, 1, 1)
    ...
    def retranslateUi(self, Form):
        ...
        self.lttbRadio.setToolTip(_translate("Form", "Downsample using Largest-Triangle-Three-Buckets requires lttb package to be installed."))
        self.lttbRadio.setText(_translate("Form", "Lttb"))
        self.lttbSpin.setToolTip(_translate("Form", "Threshold value for lttb down-sampling."))
        self.lttbSpin.setSuffix(_translate("Form", "x"))
