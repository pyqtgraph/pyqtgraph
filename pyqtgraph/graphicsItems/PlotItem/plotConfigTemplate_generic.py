...
class Ui_Form(object):
    def setupUi(self, Form):
        ...
        self.gridLayout_4.addWidget(self.clipToViewCheck, 8, 0, 1, 3)
        self.maxTracesCheck = QtWidgets.QCheckBox(self.decimateGroup)
        self.maxTracesCheck.setObjectName("maxTracesCheck")
        self.gridLayout_4.addWidget(self.maxTracesCheck, 9, 0, 1, 2)
        ...
        self.lttbcRadio = QtWidgets.QRadioButton(self.decimateGroup)
        self.lttbcRadio.setObjectName("lttbcRadio")
        self.gridLayout_4.addWidget(self.lttbcRadio, 7, 1, 1, 1)
        self.lttbcSpin = QtWidgets.QSpinBox(self.decimateGroup)
        self.lttbcSpin.setMinimum(1)
        self.lttbcSpin.setMaximum(100000)
        self.lttbcSpin.setProperty("value", 1000)
        self.lttbcSpin.setObjectName("lttbcSpin")
        self.gridLayout_4.addWidget(self.lttbcSpin, 7, 2, 1, 1)
        self.maxTracesSpin = QtWidgets.QSpinBox(self.decimateGroup)
        self.maxTracesSpin.setObjectName("maxTracesSpin")
        self.gridLayout_4.addWidget(self.maxTracesSpin, 9, 2, 1, 1)
        self.forgetTracesCheck = QtWidgets.QCheckBox(self.decimateGroup)
        self.forgetTracesCheck.setObjectName("forgetTracesCheck")
        self.gridLayout_4.addWidget(self.forgetTracesCheck, 10, 0, 1, 3)
    ...
    def retranslateUi(self, Form):
        ...
        self.lttbcRadio.setToolTip(_translate("Form", "Downsample using Largest-Triangle-Three-Buckets requires lttbc package to be installed."))
        self.lttbcRadio.setText(_translate("Form", "Lttbc"))
        self.lttbcSpin.setToolTip(_translate("Form", "Threshold value for lttbc down-sampling."))
        self.lttbcSpin.setSuffix(_translate("Form", "x"))
