...
class Handle(UIGraphicsItem):
    ...
    def __init__(self, radius, typ=None, pen=fn.mkPen(QtGui.QColor(0,0,0), width=2), parent=None, deletable=False, brush=QtGui.QBrush(QtCore.Qt.white)):
        ...
        self.radius = radius
        self.typ = typ
        self.pen = fn.mkPen(QtGui.QColor(0,0,0), width=2)
        self.currentPen = self.pen
        self.pen.setWidth(1)
    ...
    def hoverEvent(self, ev):
        ...
        if hover:
            self.currentPen = fn.mkPen(QtGui.QColor(250,250,0), width=2)
        else:
            self.currentPen = self.pen
        self.update()
    ...
    def paint(self, p, opt, widget):
        ...
        if self.brush is None:
          gradient = QtGui.QRadialGradient(QtCore.QPoint(0,0), 1)
